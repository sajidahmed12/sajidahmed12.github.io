...
Previously, I worked as a Computer Vision AI Engineer at AlterSense Limited, where I led the development of a deep learning–based human activity recognition system tailored for the ready-made garments (RMG) industry in Bangladesh. In this role, I designed and implemented a temporal action segmentation model based on Video Mamba, achieving ~82% accuracy on in-house proprietary video datasets. My work was supervised by [Dr. Nabeel Mohammed](https://scholar.google.com.au/citations?hl=en&user=w5djOYsAAAAJ&view_op=list_works&sortby=pubdate).

Prior to this, I served as a Lab Instructor at [North South University](https://www.northsouth.edu) for nearly three years, where I mentored undergraduate students across a broad range of computer science and engineering courses. I was also awarded a research fellowship through the [Fatima Fellowship Program](https://www.fatimafellowship.com/), during which I worked on a project titled “Emerging Number Format Effect on ML Runtime Performance” under the supervision of [Dr. Abdulrahman Mahmoud](https://ma3mool.github.io/). Earlier, I worked as a Research Assistant intern at the [TnR Biomedical Research Lab](https://github.com/TnR-Lab), contributing to interdisciplinary projects at the intersection of biomedical signal processing and deep learning.

I earned my B.Sc. in Computer Science and Engineering from [North South University](https://www.northsouth.edu), under the supervision of [Dr. Mohammad Ashrafuzzaman Khan](https://ece.northsouth.edu/people/dr-mohammad-ashrafuzzaman-khan/) and [Dr. Tanzilur Rahman](https://sites.google.com/site/tanzilctg) from the Department of Electrical and Computer Engineering. My undergraduate thesis, titled "Road Crack Segmentation with Driving Assistance and Real-time Feedback System", focused on applying computer vision techniques to intelligent transportation systems.
...
# News:
- **<span style="color:red">New!</span>** [Jan 2026](#) I am starting my Doctoral Studies in Computer Science at the University of Kentucky this Spring 2026. 
...
- [July 2024](#) One of my recent works on Conversational AI Systems is available now on [ArXiV](https://arxiv.org/abs/2502.13298)
